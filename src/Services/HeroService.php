...
class HeroService
{
    ...
    function __construct()
    {
       ...
       /**  $this->_listeHeros = [new Hero('Harley','MacKenzy','Harley Queen',true,'une psychiatre reconvertie en psychotique')];*/
        /** array_push($_listeHeros,new Hero('Brice','Wayne','Batman',false,'une chauve souris avec une grosse super car')); */
        $this->addHero(new Hero('Harley','MacKenzy','Harley Queen',true,'une psychiatre reconvertie en psychotique'));
